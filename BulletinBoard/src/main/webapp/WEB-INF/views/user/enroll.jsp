...
<body>
<h2 class="jumbotron" style="text-align: center">Enroll</h2>
	<div class="container">
		<div class="row">
			<form action="/user/enroll" method="post">
				<div class="form-group">
					...
					<div class="col-xs-10">
						<input class="form-control" id="id" name="id" type="text" required maxlength="20">
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-2 control-label" for="pw">PW</label>
					<div class="col-xs-10">
						<input class="form-control" id="pw" name="pw" type="password" required maxlength="30">
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-2 control-label" for="name">Name</label>
					<div class="col-xs-10">
						<input class="form-control" id="name" name="name" type="text" required maxlength="10">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-xs-10">
						<input class="form-control btn btn-info" type="submit" value="Enroll" >
					</div>
				</div>
			</form>
		</div>
